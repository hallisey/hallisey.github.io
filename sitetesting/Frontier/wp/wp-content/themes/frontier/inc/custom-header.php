<?php
/**
 * Implement Custom Header functionality for frontier
 *
 * @package WordPress
...
function frontier_custom_header_setup() {
	/**
	 * Filter frontier custom-header support arguments.
	 *
	 * @since frontier 1.0
	 *
	 * @param array $args {
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'frontier_custom_header_args', array(
...
function frontier_header_style() {
	...
	?>
	<style type="text/css" id="frontier-header-css">
	<?php
...
?>
	<style type="text/css" id="frontier-admin-header-css">
